...
#endif
{
    if (N & 8) {
        ...
        vfloat32mf2_t B0;
        if (!S2) {
            B0 = __riscv_vle32_v_f32mf2(B, 4);
        }

        vfloat32mf2_t result0, result1, result2, result3, result4, result5, result6, result7;
        vfloat32mf2_t result8, result9, resultA, resultB, resultC, resultD, resultE;
        ...
        if (M & 8) {
             if (S2) {
                ...
                result03 = __riscv_vfmul_vf_f32m1(A4, B[3], 8);
            } else {
                result0 = __riscv_vfmul_vf_f32mf2(B0, A0[0], 4);
                result1 = __riscv_vfmul_vf_f32mf2(B0, A0[1], 4);
                result2 = __riscv_vfmul_vf_f32mf2(B0, A0[2], 4);
                result3 = __riscv_vfmul_vf_f32mf2(B0, A0[3], 4);
                result4 = __riscv_vfmul_vf_f32mf2(B0, A0[4], 4);
                result5 = __riscv_vfmul_vf_f32mf2(B0, A0[5], 4);
                result6 = __riscv_vfmul_vf_f32mf2(B0, A0[6], 4);
                result7 = __riscv_vfmul_vf_f32mf2(B0, A0[7], 4);
            }
#ifndef GEMM_NEW_PACKING
            A0 += 8;
#endif
...
#ifdef GEMM_NEW_PACKING
        if (M & 4) {
            result8 = __riscv_vfmul_vf_f32mf2(B0, A0[0 + (M & 0x8)], 4);
            result9 = __riscv_vfmul_vf_f32mf2(B0, A0[1 + (M & 0x8)], 4);
            resultA = __riscv_vfmul_vf_f32mf2(B0, A0[2 + (M & 0x8)], 4);
            resultB = __riscv_vfmul_vf_f32mf2(B0, A0[3 + (M & 0x8)], 4);
        }
        if (M & 2) {
            resultC = __riscv_vfmul_vf_f32mf2(B0, A0[0 + (M & 0xC)], 4);
            resultD = __riscv_vfmul_vf_f32mf2(B0, A0[1 + (M & 0xC)], 4);
        }
        if (M & 1) {
            resultE = __riscv_vfmul_vf_f32mf2(B0, A0[0 + (M & 0xE)], 4);
        }
        A0 += M;
#else
        if (M & 4) {
            result8 = __riscv_vfmul_vf_f32mf2(B0, A1[0], 4);
            result9 = __riscv_vfmul_vf_f32mf2(B0, A1[1], 4);
            resultA = __riscv_vfmul_vf_f32mf2(B0, A1[2], 4);
            resultB = __riscv_vfmul_vf_f32mf2(B0, A1[3], 4);
            A1 += 4;
        }
        if (M & 2) {
            resultC = __riscv_vfmul_vf_f32mf2(B0, A2[0], 4);
            resultD = __riscv_vfmul_vf_f32mf2(B0, A2[1], 4);
            A2 += 2;
        }
        if (M & 1) {
            resultE = __riscv_vfmul_vf_f32mf2(B0, A3[0], 4);
            A3 += 1;
        }
#endif
        ...
        for (BLASLONG k = 1; k < K; k++) {
            ...
            if (M & 8) {
                if (S2) {
                    ...
                    result03 = __riscv_vfmacc_vf_f32m1(result03, B[3], A4, 8);
                } else {
                    result0 = __riscv_vfmacc_vf_f32mf2(result0, A0[0], B0, 4);
                    result1 = __riscv_vfmacc_vf_f32mf2(result1, A0[1], B0, 4);
                    result2 = __riscv_vfmacc_vf_f32mf2(result2, A0[2], B0, 4);
                    result3 = __riscv_vfmacc_vf_f32mf2(result3, A0[3], B0, 4);
                    result4 = __riscv_vfmacc_vf_f32mf2(result4, A0[4], B0, 4);
                    result5 = __riscv_vfmacc_vf_f32mf2(result5, A0[5], B0, 4);
                    result6 = __riscv_vfmacc_vf_f32mf2(result6, A0[6], B0, 4);
                    result7 = __riscv_vfmacc_vf_f32mf2(result7, A0[7], B0, 4);
                }
#ifndef GEMM_NEW_PACKING
                A0 += 8;
#endif
...
#ifdef GEMM_NEW_PACKING
            if (M & 4) {
                result8 = __riscv_vfmacc_vf_f32mf2(result8, A0[0 + (M & 0x8)], B0, 4);
                result9 = __riscv_vfmacc_vf_f32mf2(result9, A0[1 + (M & 0x8)], B0, 4);
                resultA = __riscv_vfmacc_vf_f32mf2(resultA, A0[2 + (M & 0x8)], B0, 4);
                resultB = __riscv_vfmacc_vf_f32mf2(resultB, A0[3 + (M & 0x8)], B0, 4);
            }
            if (M & 2) {
                resultC = __riscv_vfmacc_vf_f32mf2(resultC, A0[0 + (M & 0xC)], B0, 4);
                resultD = __riscv_vfmacc_vf_f32mf2(resultD, A0[1 + (M & 0xC)], B0, 4);
            }
            if (M & 1) {
                resultE = __riscv_vfmacc_vf_f32mf2(resultE, A0[0 + (M & 0xE)], B0, 4);
            }
            A0 += M;
#else
            if (M & 4) {
                result8 = __riscv_vfmacc_vf_f32mf2(result8, A1[0], B0, 4);
                result9 = __riscv_vfmacc_vf_f32mf2(result9, A1[1], B0, 4);
                resultA = __riscv_vfmacc_vf_f32mf2(resultA, A1[2], B0, 4);
                resultB = __riscv_vfmacc_vf_f32mf2(resultB, A1[3], B0, 4);
                A1 += 4;
            }
            if (M & 2) {
                resultC = __riscv_vfmacc_vf_f32mf2(resultC, A2[0], B0, 4);
                resultD = __riscv_vfmacc_vf_f32mf2(resultD, A2[1], B0, 4);
                A2 += 2;
            }
            if (M & 1) {
                resultE = __riscv_vfmacc_vf_f32mf2(resultE, A3[0], B0, 4);
                A3 += 1;
            }
#endif
        }
        ...
        if (M & 8) {
            if (S2) {
                ...
                vfloat32m4_t c24 = __riscv_vcreate_v_f32m1_f32m4(result00, result01, result02, result03);
                c14 = __riscv_vfmacc_vf_f32m4(c14, alpha, c24, 4 * 8);
                __riscv_vse32_v_f32m4(C, c14, 4 * 8);
            } else {
                vfloat32mf2x8_t c18 = __riscv_vlsseg8e32_v_f32mf2x8(C, ldc * sizeof(float), 4);
        ...
        vfloat32m1_t result10, result11, result12, result13;
        float r0, r1, r2, r8, r9, rA, rC, rD, rE, a0, a1, a2;
        float B0, B1, B2;
        FLOAT *B00, *B01;
        const bool S2 = (S && (M == 8));
        ...
        if (N & 4) {
            ...
            if (M & 8) {
                if (S2) {
                    result10 = __riscv_vfmul_vf_f32m1(result03, B[0], 8);
                    result11 = __riscv_vfmul_vf_f32m1(result03, B[1], 8);
                    result12 = __riscv_vfmul_vf_f32m1(result03, B[2], 8);
                    result13 = __riscv_vfmul_vf_f32m1(result03, B[3], 8);
                } else {
        ...
        for (BLASLONG k = 1; k < K; k++) {
            ...
            if (N & 4) {
                ...
                if (M & 8) {
                    if (S2) {
                        result10 = __riscv_vfmacc_vf_f32m1(result10, B[0], result03, 8);
                        result11 = __riscv_vfmacc_vf_f32m1(result11, B[1], result03, 8);
                        result12 = __riscv_vfmacc_vf_f32m1(result12, B[2], result03, 8);
                        result13 = __riscv_vfmacc_vf_f32m1(result13, B[3], result03, 8);
                    } else {
        ...
        if (N & 4) {
            ...
            if (M & 8) {
                if (S2) {
                    ...
                    vfloat32m4_t c24 = __riscv_vcreate_v_f32m1_f32m4(result10, result11, result12, result13);
                    c14 = __riscv_vfmacc_vf_f32m4(c14, alpha, c24, 4 * 8);
