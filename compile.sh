...
export COMMON_FLAGS="${OPT_FLAGS} -march=rv64imafdcv_zvl256b_zvfh_zfh_zvfhmin_zfhmin_zfbfmin_zvfbfmin_zvfbfwma -Wall"
#export COMMON_FLAGS="${OPT_FLAGS} -march=rv64imafdcv_zvl128b_zvfh_zfh_zvfhmin_zfhmin_zfbfmin_zvfbfmin_zvfbfwma -Wall"
