...
./testOpenBLAS $ARCH 1 1 $SIZE $SIZE $SIZE 1 0.0 4.0
./testOpenBLAS $ARCH 0 0 $SIZE $SIZE $SIZE 1 1.0 4.0
./testOpenBLAS $ARCH 1 1 $SIZE $SIZE $SIZE 1 1.0 4.0

# Test betas
#./testOpenBLAS $ARCH 0 0 $SIZE $SIZE $SIZE 1 2.0 0.0
#./testOpenBLAS $ARCH 1 1 $SIZE $SIZE $SIZE 1 2.0 0.0
#./testOpenBLAS $ARCH 0 0 $SIZE $SIZE $SIZE 1 2.0 1.0
#./testOpenBLAS $ARCH 1 1 $SIZE $SIZE $SIZE 1 2.0 1.0
...
./testOpenBLAS $ARCH 1 1 $SIZE $SIZE $SIZE 1 2.0 4.0 2
